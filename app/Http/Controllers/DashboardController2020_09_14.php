...
class DashboardController extends Controller
{
  ...
  public function dashboard(){
   ...
   // User::count();
    ...
    from(
          ...
          from
          users INNER JOIN leave_requests
   ...
   { 
    ...
    if($client_name==null){  
     ...
     if($day=='Monday'){
       ...
       from
       (SELECT u.id, ADDTIME(CONCAT('".$date."' ,' ',tcat.tc_monday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       ...
       from
       (SELECT u.id, ADDTIME(CONCAT('".$first_day_of_week."' ,' ',tcat.tc_monday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$second_day_of_week."' ,' ',tcat.tc_monday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       $third_day_query =   "SELECT  sum(IF(temp.attendance_time > temp.time_in,1,0)) as 'late',
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$third_day_of_week."' ,' ',tcat.tc_monday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       and date(datetime)='".$third_day_of_week."' and u.flag=1 
       and u.status=1 
       GROUP by u.id order by u.id,datetime) as temp";
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fourth_day_of_week."' ,' ',tcat.tc_monday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fifth_day_of_week."' ,' ',tcat.tc_monday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$sixth_day_of_week."' ,' ',tcat.tc_monday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
     ...
     if($day=='Tuesday'){
       $daily_present="SELECT  sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$date."' ,' ',tcat.tc_tuesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join time_categories tcat on tcat.id  =u.tcat_id
       inner join attendance att on att.user_id=u.id 
       where c.parent_id = '".Session::get('dep_id')."' and date(datetime)='".$date."' and u.flag=1 and u.status=1 GROUP by u.id order by u.id,datetime) as temp";
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$first_day_of_week."' ,' ',tcat.tc_tuesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$second_day_of_week."' ,' ',tcat.tc_tuesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$third_day_of_week."' ,' ',tcat.tc_tuesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fourth_day_of_week."' ,' ',tcat.tc_tuesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fifth_day_of_week."' ,' ',tcat.tc_tuesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$sixth_day_of_week."' ,' ',tcat.tc_tuesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
     ...
     if($day=='Wednesday'){
       ...
       $daily_present="SELECT  sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$date."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join time_categories tcat on tcat.id  =u.tcat_id
       inner join attendance att on att.user_id=u.id 
       where c.parent_id = '".Session::get('dep_id')."' and date(datetime)='".$date."' and u.flag=1 and u.status=1 GROUP by u.id order by u.id,datetime) as temp";
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$first_day_of_week."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$second_day_of_week."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$third_day_of_week."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fourth_day_of_week."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fifth_day_of_week."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$sixth_day_of_week."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
     ...
     if($day=='Thursday'){
       $daily_present="SELECT  sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$date."' ,' ',tcat.tc_thursday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join time_categories tcat on tcat.id  =u.tcat_id
       inner join attendance att on att.user_id=u.id 
       where c.parent_id = '".Session::get('dep_id')."' and date(datetime)='".$date."' and u.flag=1 and u.status=1 GROUP by u.id order by u.id,datetime) as temp";
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$first_day_of_week."' ,' ',tcat.tc_thursday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$second_day_of_week."' ,' ',tcat.tc_thursday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$third_day_of_week."' ,' ',tcat.tc_thursday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fourth_day_of_week."' ,' ',tcat.tc_thursday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fifth_day_of_week."' ,' ',tcat.tc_thursday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$sixth_day_of_week."' ,' ',tcat.tc_thursday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
     ...
     if($day=='Friday'){
       $daily_present="SELECT  sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$date."' ,' ',tcat.tc_friday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join time_categories tcat on tcat.id  =u.tcat_id
       inner join attendance att on att.user_id=u.id 
       where c.parent_id = '".Session::get('dep_id')."' and date(datetime)='".$date."' and u.flag=1 and u.status=1 GROUP by u.id order by u.id,datetime) as temp";
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$first_day_of_week."' ,' ',tcat.tc_friday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$second_day_of_week."' ,' ',tcat.tc_friday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$third_day_of_week."' ,' ',tcat.tc_friday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fourth_day_of_week."' ,' ',tcat.tc_friday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fifth_day_of_week."' ,' ',tcat.tc_friday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$sixth_day_of_week."' ,' ',tcat.tc_friday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
     ...
     if($day=='Saturday'){
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$third_day_of_week."' ,' ',tcat.tc_satureday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fourth_day_of_week."' ,' ',tcat.tc_satureday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fifth_day_of_week."' ,' ',tcat.tc_satureday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$sixth_day_of_week."' ,' ',tcat.tc_satureday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
     ...
     if($day=='Sunday'){
       ...
       $daily_present="SELECT  sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$date."' ,' ',tcat.tc_sunday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join time_categories tcat on tcat.id  =u.tcat_id
       inner join attendance att on att.user_id=u.id 
       where c.parent_id = '".Session::get('dep_id')."' and date(datetime)='".$date."' and u.flag=1 and u.status=1 GROUP by u.id order by u.id,datetime) as temp";
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$first_day_of_week."' ,' ',tcat.tc_sunday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$second_day_of_week."' ,' ',tcat.tc_sunday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$third_day_of_week."' ,' ',tcat.tc_sunday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fourth_day_of_week."' ,' ',tcat.tc_sunday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$fifth_day_of_week."' ,' ',tcat.tc_sunday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
       ...
       sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'late'
       from
       (SELECT u.id, ADDTIME(CONCAT('".$sixth_day_of_week."' ,' ',tcat.tc_sunday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
       from users u INNER JOIN clients c on u.department_id= c.id 
       inner join attendance att on att.user_id=u.id 
       inner join time_categories tcat on tcat.id=u.tcat_id 
       where c.parent_id = '".Session::get('dep_id')."' 
  ...
  $first_day_of_weekly_graph_absent=$all_users[0]->user_id-$first_day_of_weekly_graph_present_late;
    ...
    //   dd($all_users[0]->user_id);
    // dd($first_day_of_weekly_graph[0]->present);
    //  dd($first_day_of_weekly_graph[0]->late);
 ...
 $third_day_of_weekly_graph  =  DB::select(DB::raw($third_day_query));
...
$total_present_in_week = $first_day_of_weekly_graph[0]->present+ $second_day_of_weekly_graph[0]->present +$third_day_of_weekly_graph[0]->present + $fourth_day_of_weekly_graph[0]->present + $fifth_day_of_weekly_graph[0]->present + $sixth_day_of_weekly_graph[0]->present;                  
  ...
  if($client_check_sub_child==null){
   ...
   if($day=='Wednesday'){
     ...
     inner join time_categories tcat on tcat.id  =u.tcat_id
     inner join attendance att on att.user_id=u.id 
     where c.parent_id = '".Session::get('dep_id')."' and date(datetime)='".$date."' and u.flag=1 and u.status=1 GROUP by u.id order by u.id) as temp";
     $daily_late="SELECT  sum(IF(temp.attendance_time > temp.time_in,1,0)) as 'late'
     from
     (SELECT u.id, ADDTIME(CONCAT('".$date."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
     from users u INNER JOIN clients c on u.department_id= c.id 
     ...
     and date(datetime)='".$first_day_of_week."' and u.flag=1 
     and u.status=1 
     GROUP by u.id order by u.id) as temp";   
     $second_day_query =   "SELECT  sum(IF(temp.attendance_time > temp.time_in,1,0)) as 'late',
     sum(IF(temp.attendance_time < temp.time_in,1,0)) as 'present'
     from
     (SELECT u.id, ADDTIME(CONCAT('".$second_day_of_week."' ,' ',tcat.tc_wednesday_in),tcat.grace_time) as time_in,att.datetime as attendance_time
   ...
   $daily_late_count = DB::select( DB::raw($daily_late));
    //generating load by attenenanc in daliy leave
   $daily_leave="SELECT count(1) as leave_title      
   FROM(
   SELECT u.id,u.name,u.flag,lev_re.leave_date,att.datetime from users u 
   INNER JOIN clients c on c.id = u.department_id
...
$idds=$fetch_user_quer->pluck('id')->toArray();
...
if($day=="Monday"){
  ...
  inner join time_categories tcat on tcat.id  =u.tcat_id
  inner join attendance att on att.user_id=u.id 
  where u.department_id in ('".$ids."') and date(datetime)='".$date."' and u.flag=1 and u.status=1 GROUP by u.id order by u.id,datetime) as temp";
...
INNER JOIN leave_requests_details lev_re on lev_re.user_id=u.id
LEFT join attendance att on att.user_id=u.id and date(att.datetime)='".$date."'
WHERE  u.department_id in ('".$ids."') and u.flag=1 and u.status=1 AND lev_re.leave_date='".$date."' and att.datetime is null group by lev_re.user_id) as temp";
$daily_leave_count = DB::select( DB::raw($daily_leave));
$daily_attach= "SELECT count(1) as attach_count FROM attach_employees_details 
INNER JOIN users on users.id= attach_employees_details.user_id
INNER JOIN clients on clients.id= users.department_id
...
$total_late_and_present_leave =  $daily_late_count[0]->late + $daily_present_count[0]->present +  $daily_leave_count[0]->leave_title + $daily_attach_count[0]->attach_count;
$users="select count(users.id) as user_id from users INNER JOIN clients on users.department_id =clients.id WHERE users.department_id in ('".$ids."') and users.flag=1 and users.status=1";
$all_users = DB::select( DB::raw($users));
$daily_absent_count =  $all_users[0]->user_id -   $total_late_and_present_leave;

                  //weekly grap for main account for pbm like
$month = date('m', strtotime("this week"));
...
INNER JOIN leave_requests_details lev_re on lev_re.user_id=u.id
LEFT join attendance att on att.user_id=u.id and date(att.datetime)='".$first_day_of_week."'
WHERE u.department_id in ('".$ids."')   and u.flag=1 and u.status=1 AND lev_re.leave_date='".$first_day_of_week."' and att.datetime is null group by lev_re.user_id) as temp";
$first_day_of_weekly_graph_leave  =  DB::select(DB::raw($first_day_leave));  
$first_day_attach= "SELECT count(1) as attach_count FROM attach_employees_details 
INNER JOIN users on users.id= attach_employees_details.user_id
INNER JOIN clients on clients.id= users.department_id
...
INNER JOIN leave_requests_details lev_re on lev_re.user_id=u.id
LEFT join attendance att on att.user_id=u.id and date(att.datetime)='".$second_day_of_week."'
WHERE u.department_id in ('".$ids."') and u.flag=1 and u.status=1 AND lev_re.leave_date='".$second_day_of_week."' and att.datetime is null group by lev_re.user_id) as temp";
$second_day_of_weekly_graph_leave  =  DB::select(DB::raw($second_day_leave)); 
$second_day_attach= "SELECT count(1) as attach_count FROM attach_employees_details 
INNER JOIN users on users.id= attach_employees_details.user_id
INNER JOIN clients on clients.id= users.department_id
...
INNER JOIN leave_requests_details lev_re on lev_re.user_id=u.id
LEFT join attendance att on att.user_id=u.id and date(att.datetime)='".$third_day_of_week."'
WHERE  u.department_id in ('".$ids."') and u.flag=1 and u.status=1 AND lev_re.leave_date='".$third_day_of_week."' and att.datetime is null group by lev_re.user_id) as temp";
$third_day_of_weekly_graph_leave  =  DB::select(DB::raw($third_day_leave)); 
$third_day_attach= "SELECT count(1) as attach_count FROM attach_employees_details 
INNER JOIN users on users.id= attach_employees_details.user_id
INNER JOIN clients on clients.id= users.department_id
...
INNER JOIN leave_requests_details lev_re on lev_re.user_id=u.id
LEFT join attendance att on att.user_id=u.id and date(att.datetime)='".$fourth_day_of_week."'
WHERE u.department_id in ('".$ids."') and u.flag=1 and u.status=1 AND lev_re.leave_date='".$fourth_day_of_week."' and att.datetime is null group by lev_re.user_id) as temp";
$fourth_day_of_weekly_graph_leave  =  DB::select(DB::raw($fourth_day_leave)); 
$fourth_day_attach= "SELECT count(1) as attach_count FROM attach_employees_details 
INNER JOIN users on users.id= attach_employees_details.user_id
INNER JOIN clients on clients.id= users.department_id
...
INNER JOIN leave_requests_details lev_re on lev_re.user_id=u.id
LEFT join attendance att on att.user_id=u.id and date(att.datetime)='".$fifth_day_of_week."'
WHERE u.department_id in ('".$ids."') and u.flag=1 and u.status=1 AND lev_re.leave_date='".$fifth_day_of_week."' and att.datetime is null group by lev_re.user_id) as temp";
$fifth_day_of_weekly_graph_leave  =  DB::select(DB::raw($fifth_day_leave)); 
...
INNER JOIN leave_requests_details lev_re on lev_re.user_id=u.id
LEFT join attendance att on att.user_id=u.id and date(att.datetime)='".$sixth_day_of_week."'
WHERE u.department_id in ('".$ids."')  and u.flag=1 and u.status=1 AND lev_re.leave_date='".$sixth_day_of_week."' and att.datetime is null group by lev_re.user_id) as temp";
$sixth_day_of_weekly_graph_leave  =  DB::select(DB::raw($sixth_day_leave));
$sixth_day_attach= "SELECT count(1) as attach_count FROM attach_employees_details 
INNER JOIN users on users.id= attach_employees_details.user_id
INNER JOIN clients on clients.id= users.department_id
