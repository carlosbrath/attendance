...
<form action="" class="col-md-12 tiles card_shadow white dataTables_filter m-b-5" method="get">
  ...
  <div class="p-t-10 p-b-10 p-l-5 p-r-5">
    <div class="row clearfix">
      ...
      <div class="col-md-6 m-y-2 jquicss">
        <input type="text" name="allregions_input" id="allregions_input" value="" class="form-control pull-left" placeholder="Enter Region, District or Tehsil" style="width:calc(100% - 47px)!important">
