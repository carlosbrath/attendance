            ...
            <div class="grid simple form-grid">
                <div class="grid-body no-border">
                    <form class="form-no-horizontal-spacing"
                           method="post" 
                            action="{{route('allowances.update',$allownace->id)}}"
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row form-row">
                                    <div class="col-md-8">
                                        ...
                                        <input name="title" autocomplete="off" id="form3FirstName" value="{{$allownace->title}}" type="text" class="form-control" placeholder="Enter Title">
                                        @if($errors->any())
