              ...
              @if($department['registered']['total']>0)
                <tr>
                  <td class="v-align-middle bold text-success">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs']]) }}">
                      {{ $department->name }}
                    </a>
                  </td>
                  <td class="v-align-middle"><span class="muted">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs'],'list'=>'yes','emp_type'=>'Regular']) }}">
                    {{ $department['registered']['childs']['Regular'] }}</a></span> 
                    
                  </td>
                  <td class="v-align-middle"><span class="muted">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs'],'list'=>'yes','emp_type'=>'Contract']) }}">
                    {{ $department['registered']['childs']['Contract'] }}</a></span> 
                    
                  </td>
                  <td class="v-align-middle"><span class="muted">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs'],'list'=>'yes','emp_type'=>'Contingency']) }}">
                    {{ $department['registered']['childs']['Contingency'] }}</a></span> 
                    
                  </td>
                  <td class="v-align-middle"><span class="muted">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs'],'list'=>'yes','emp_type'=>'Temporary']) }}">
                    {{ $department['registered']['childs']['Temporary'] }}</a></span> 
                    
                  </td>
                  <td class="v-align-middle"><span class="muted">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs'],'list'=>'yes','emp_type'=>'Attach']) }}">
                    {{ $department['registered']['childs']['Attach'] }}</a></span> 
                    
                  </td>
                  <td class="v-align-middle"><span class="muted">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs'],'list'=>'yes','emp_type'=>'NotSet']) }}">
                    {{ $department['registered']['childs']['NotSet'] }}</a></span> 
                    
                  </td>
                  <td class="v-align-middle"><span class="muted">
                    <a href="{{ route('dw-unregistered',['department_id'=>$department->id,'selected_dmgs'=>$data['selected_dmgs'],'list'=>'yes']) }}">
