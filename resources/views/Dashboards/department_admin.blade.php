...
*/
 ...
 ?>
<div class="row">
  <div class="col-md-12 tiles white m-b-20">
    <div class="grid simple" style="position: static;">
      ...
      <div class="grid-body no-border" style="display: block;">
        ...
        <div class="grid-body no-border" style="display: block;">
          <div class="box-wrap">
            <div class="box">
                <div class="text-center rcorners2 " style="background-color: #144681">
                <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
                <a href="{{url('users')}}" class="text-white">{{$total_departmental_employees}}</a></h2>
                <h4 class="bold text-white">All</h4></div>
            </div>
            <div class="box">
                <div class=" text-center rcorners2" style="background-color: #00C851">
                    <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
            ...
            <div class="box">
                <div class=" text-center rcorners2" style="background-color: #F3A406">
                    <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
            ...
            <div class="box">
                <div class=" text-center rcorners2" style="background-color: #FF4444">
                    <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
            ...
            <div class="box">
                <div class="bg-primary text-center rcorners2" style="background-color: #144681">
                    <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
    ...
    <div class="col-md-12 tiles white m-b-20">
        ...
        <div class="grid-title no-border">
            ...
            <div class="grid-body no-border" style="display: block;">
              <div class="box-wrap">
                  <div class="box">
                      <div class=" text-center rcorners2 " style="background-color: #577089;  color: white">
                      <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
                      <a href="{{url('employee/field_staff')}}" style="color: white">{{$total_departmental_employees_fieldstaff}}</a></h2>
                      <h4 class="bold text-white">Field Staff</h4></div>
                  </div>
                  
                  <div class="box">
                      <div class=" text-center rcorners2 " style="background-color: #1E90FF;  color: white">
                      <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
                      <a href="{{url('employee/employee_leave')}}" style="color: white">{{$daily_leave}}</a></h2>
                      <h4 class="bold text-white">Leave</h4></div>
                  </div>
                  <div class="box">
                      <div class=" text-center rcorners2" style="background-color: #144681;  color: white">
                          <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
                          <a href="{{url('employee/employee_attach')}}" style="color: white"> {{$daily_attach}}</a></h2>
                          <h4 class="bold text-white">On-Duty</h4>
                      </div>
                  </div>
                  <div class="box">
                      <div class=" text-center rcorners2" style=                                                                                                                              "background-color: #26718E;  color: white">
                          <h2 class="semi-bold text-white weather-widget-big-text no-margin p-t-35 p-b-10">
                              <a href="{{url('employee/employee_short_leave')}}" style="color: white"> {{$short_leave_count}}</a></h2>
      ...
      <div class="tiles-body">
        ...
        <div class="widget-stats">
          <div class="wrapper transparent">
            ...
            <span class="item-title">On-Duty</span> <span class="item-count animate-number semi-bold" data-value="{{$daily_attach}}" data-animation-duration="700">0</span>
            </a>
          </div>
        </div>
        <div class="widget-stats ">
        ...
        <div class="description"> <span class="text-white mini-description ">Leave/On-Duty Employees <span class="blend">Today</span></span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="tiles red m-b-10">
      <div class="tiles-body">
        ...
        <div class="widget-stats">
          <div class="wrapper transparent">
          <a  style="text-decoration: none;color:white">
            <span class="item-title">Without Mask</span> <span class="item-count animate-number semi-bold" data-value="{{ $ai_features[0]->no_mask }}" data-animation-duration="700"></span>
          </div>
         </a>
        </div>
        <div class="widget-stats ">
          <div class="wrapper last">
            <a  style="text-decoration: none;color:white">
            <span class="item-title">With Mask</span> <span class="item-count animate-number semi-bold" data-value="{{ $ai_features[0]->masked }}" data-animation-duration="700"></span>
          </a>
          </div>
        </div>
        <div class="progress transparent progress-small no-radius m-t-20" style="width:90%">
        ...
        <div class="description"> <span class="text-white mini-description ">Employees COVID <span class="blend"> SOP Compliance</span></span>
        </div>
      </div>
    </div>
  </div>
  <div class="col-md-8 col-vlg-8 col-sm-6">
    <div class="tiles green m-b-10">
      <div class="tiles-body">
        ...
        <div class="widget-stats">
          <div class="wrapper transparent">
          <a  style="text-decoration: none;color:white">
            <span class="item-title">Happy</span> <span class="item-count animate-number semi-bold" data-value="{{ $ai_features[0]->happy }}" data-animation-duration="700"></span>
          </div>
         </a>
        </div>
        <div class="widget-stats ">
          <div class="wrapper last">
            <a  style="text-decoration: none;color:white">
            <span class="item-title">Angry</span> <span class="item-count animate-number semi-bold" data-value="{{ $ai_features[0]->angry }}" data-animation-duration="700"></span>
          </a>
          </div>
        </div>
        <div class="widget-stats ">
          <div class="wrapper last">
            <a  style="text-decoration: none;color:white">
            <span class="item-title">Calm</span> <span class="item-count animate-number semi-bold" data-value="{{ $ai_features[0]->calm }}" data-animation-duration="700"></span>
          </a>
          </div>
        </div>
        ...
        <div class="widget-stats ">
          <div class="wrapper last">
            <a  style="text-decoration: none;color:white">
            <span class="item-title">Confused</span> <span class="item-count animate-number semi-bold" data-value="{{ $ai_features[0]->confuse }}" data-animation-duration="700"></span>
          </a>
          </div>
        </div>
        ...
        <div class="widget-stats ">
          <div class="wrapper last">
            <a  style="text-decoration: none;color:white">
            <span class="item-title">Surprised</span> <span class="item-count animate-number semi-bold" data-value="{{ $ai_features[0]->surprise }}" data-animation-duration="700"></span>
          </a>
          </div>
        </div>
        <div class="progress transparent progress-small no-radius m-t-20" style="width:90%">
        ...
        <div class="description"> <span class="text-white mini-description ">Employees Moods <span class="blend"> today</span></span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-6 col-sm-6 col-xs-6  col-lg-6 ">
        ...
        <div class="tiles white">
            ...
            <table class="table table-responsive no-more-tables m-t-20 m-l-20 m-b-30">
                ...
                @foreach($online_offline_devices['online'] as $device)
                <tr>
                ...
                @endforeach
                @foreach($online_offline_devices['offline'] as $device)
                <tr>
                    <td class="v-align-middle"><span class="muted">{{ $device['description'] }}</span> </td>
                    <td class="v-align-middle"><span class="muted">{{ $device['serialno'] }}</span> </td>
