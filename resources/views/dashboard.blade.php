...
@section('content')
                                            ...
                                            <table class="table no-wrap">
                                                ...
                                                <tbody>
                                                    <tr class="advanced-table active">
                                                        ...
                                                        <td>
                                                            <img src="{{url('template_files/assets/images/users/1.jpg')}}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Andrew Simons</td>
                                                        <td>Modulator</td>
                                                        <td>6 May 2016</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="{{url('template_files/assets/images/users/2.jpg')}}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Hanna Gover</td>
                                                        <td>Admin </td>
                                                        <td>13 Jan 2005</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="{{url('template_files/assets/images/users/3.jpg')}}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Joshi Nirav</td>
                                                        <td>Admin</td>
                                                        <td>21 Mar 2001</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="{{url('template_files/assets/images/users/4.jpg')}}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Joshi Sunil</td>
                                                        <td>Admin</td>
                                                        <td>21 Mar 2004</td>
                                    ...
                                    <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
                                        <li class="list-group-item todo-item pt-0" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto mt-2">
                                                <li class="assignee"><img class="assignee-img" src="{{url('template_files/assets/images/users/1.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li class="assignee"><img class="assignee-img" src="{{url('template_files/assets/images/users/2.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li class="assignee"><img class="assignee-img" src="{{url('template_files/assets/images/users/3.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="assignee-img" src="{{url('template_files/assets/images/users/4.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="{{url('template_files/assets/images/big/img1.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="{{url('template_files/assets/images/big/img2.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center mb-3">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="{{url('template_files/assets/images/big/img3.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center mb-3">
                                ...
                                <ul class="list-style-none chat-list">
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="{{url('template_files/assets/images/users/1.jpg')}}" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="{{url('template_files/assets/images/users/2.jpg')}}" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="{{url('template_files/assets/images/users/3.jpg')}" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="{{url('template_files/assets/images/users/4.jpg')}}" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="{{url('template_files/assets/images/users/5.jpg')}}" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="{{url('template_files/assets/images/users/6.jpg')}}" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                                    <h5 class="mb-0 text-dark">Varun Dhavan</h5>
                                                    <small class="text-success">Online</small>
                                                </div>
                                ...
                                <div class="steamline mt-0">
                                  ...
                                  <i class="fas fa-image"></i> 
                                        ...
                                        <div class="sl-right">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <img src="{{url('template_files/assets/images/big/img1.jpg')}}" class="img-fluid">
                                                </div>
                                                <div class="col">
                                                    <img src="{{url('template_files/assets/images/big/img2.jpg')}}" class="img-fluid">
                                                </div>
                                                <div class="col">
                                                    <img src="{{url('template_files/assets/images/big/img3.jpg')}}" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{url('template_files/assets/images/users/1.jpg')}}" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{url('template_files/assets/images/users/2.jpg')}}" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{url('template_files/assets/images/users/5.jpg')}}" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                            ...
                            <div class="card-body">
                                <div class="chat-box scrollable" style="height:434px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{url('template_files/assets/images/users/1.jpg')}}" alt="user"></div>
                                        ...
                                        <li class="odd chat-item">
                                            ...
                                            <div class="chat-img"><img src="{{url('template_files/assets/images/users/2.jpg')}}" alt="user"></div>
                                        </li>
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{url('template_files/assets/images/users/3.jpg')}}" alt="user"></div>
                                            <div class="chat-content">
                                                <div class="box bg-light-success">
                                        ...
                                        <li class="odd chat-item">
                                            ...
                                            <div class="chat-img"><img src="{{url('template_files/assets/images/users/2.jpg'
                                                )}}" alt="user"></div>
                                        </li>
                                    </ul>
                                </div>
