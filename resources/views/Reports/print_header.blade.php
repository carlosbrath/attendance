...
<div class="report_header borderb onlyPrint">
    ...
    <div class="header_desc" style="width: 50%; float: left">
        ...
        <h6 class="text-center">{{ $choosen_department_name }}</h6>
        @php date_default_timezone_set('Asia/karachi'); @endphp 
        <h6 class="text-center">Report Dated: <?php echo date("d,M Y",strtotime($rep_date)) ?></h6>
        <h6 class="text-center">Printed on: <?php echo date("d,M Y h:i:s:A") ?></h6>
